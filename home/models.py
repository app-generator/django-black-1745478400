...
class Product(models.Model):
    ...
    qnt = models.TextField(max_length=255, null=True, blank=True)
...
class Tenders(models.Model):
    ...
    #__Tenders_FIELDS__
    org = models.TextField(max_length=255, null=True, blank=True)
    inn = models.IntegerField(null=True, blank=True)
    tender number = models.TextField(max_length=255, null=True, blank=True)

    #__Tenders_FIELDS__END
